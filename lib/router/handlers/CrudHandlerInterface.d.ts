...
export default interface CrudHandlerInterface {
    ...
    typeSearch(resourceType: string, searchParams: any, userIdentity: KeyValueMap, requestContext: RequestContext, serverUrl: string, tenantId?: string): any;
    typeHistory(resourceType: string, searchParams: any, userIdentity: KeyValueMap, requestContext: RequestContext, serverUrl: string, tenantId?: string): any;
    instanceHistory(resourceType: string, id: string, searchParams: any, userIdentity: KeyValueMap, requestContext: RequestContext, serverUrl: string, tenantId?: string): any;
}
